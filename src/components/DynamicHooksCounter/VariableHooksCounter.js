...
import { dynamicDecrement, dynamicIncrement } from '../redux/DynamicCounter/actionCreators';



 function VariableHooksCounter({count, increment, decrement}) {
    return (
...
export default connect(mapStateToProps, mapDispatchToProps)(VariableHooksCounter);
